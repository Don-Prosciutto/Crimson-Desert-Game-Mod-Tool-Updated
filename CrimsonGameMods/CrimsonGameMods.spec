...
a = Analysis(
    ...
    datas=[('crimson_data.db.gz', '.'), ('data', 'data'), ('vfx_equip_attachments.json', '.'), ('parc_parser.dll', '.'), ('locale', 'locale'), ('knowledge_packs', 'knowledge_packs'), ('../knowledge_packs', 'knowledge_packs'), ('quest_packs', 'quest_packs'), ('dropset_packs', 'dropset_packs'), ('localizationstring_eng_items.tsv', '.'), ('pabgb_parser_local.py', '.'), ('crimson_rs', 'crimson_rs'), ('dmm_parser', 'dmm_parser'), ('game_baselines', 'game_baselines')],
